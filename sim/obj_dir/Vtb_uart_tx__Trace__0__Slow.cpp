...
VL_ATTR_COLD void Vtb_uart_tx___024root__trace_init_sub__TOP__0(Vtb_uart_tx___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+22,0,"sampled_frame",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    tracep->declBus(c+23,0,"expected_frame",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 15,0);
    ...
    tracep->declBus(c+24,0,"i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
...
VL_ATTR_COLD void Vtb_uart_tx___024root__trace_full_0_sub_0(Vtb_uart_tx___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+22,(vlSelfRef.tb_uart_tx__DOT__sampled_frame),16);
    bufp->fullSData(oldp+23,(vlSelfRef.tb_uart_tx__DOT__expected_frame),16);
    bufp->fullIData(oldp+24,(vlSelfRef.tb_uart_tx__DOT__i),32);
