...
VlCoroutine Vtb_uart_tx___024root___eval_initial__TOP__Vtiming__0(Vtb_uart_tx___024root* vlSelf) {
    ...
    vlSymsp->_vm_contextp__->dumpfile("test5_8n1_0x55.vcd"s);
    ...
    co_await vlSelfRef.__VdlySched.delay(0x000000000000c350ULL, 
                                         nullptr, "/workspace/work/uart_tx_study/tb_uart_tx.v", 
                                         80);
    ...
    co_await vlSelfRef.__VtrigSched_hcefd327b__0.trigger(0U, 
                                                         nullptr, 
                                                         "@(posedge tb_uart_tx.PCLK)", 
                                                         "/workspace/work/uart_tx_study/tb_uart_tx.v", 
                                                         92);
    ...
    co_await vlSelfRef.__VdlySched.delay(0x00000000000186a0ULL, 
                                         nullptr, "/workspace/work/uart_tx_study/tb_uart_tx.v", 
                                         486);
    VL_FINISH_MT("/workspace/work/uart_tx_study/tb_uart_tx.v", 487, "");
    vlSelfRef.__Vm_traceActivity[3U] = 1U;
    co_return;
}
...
bool Vtb_uart_tx___024root___eval_phase__inact(Vtb_uart_tx___024root* vlSelf) {
    ...
    if (__VinactExecute) {
        VL_FATAL_MT("/workspace/work/uart_tx_study/tb_uart_tx.v", 11, "", "ZERODLY: Design Verilated with '--no-sched-zero-delay', but #0 delay executed at runtime");
    }
...
#endif
            VL_FATAL_MT("/workspace/work/uart_tx_study/tb_uart_tx.v", 11, "", "DIDNOTCONVERGE: NBA region did not converge after '--converge-limit' of 100 tries");
        }
        __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
        vlSelfRef.__VinactIterCount = 0U;
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VinactIterCount)))) {
                VL_FATAL_MT("/workspace/work/uart_tx_study/tb_uart_tx.v", 11, "", "DIDNOTCONVERGE: Inactive region did not converge after '--converge-limit' of 100 tries");
            }
            ...
            do {
                if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                    ...
                    Vtb_uart_tx___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                    VL_FATAL_MT("/workspace/work/uart_tx_study/tb_uart_tx.v", 11, "", "DIDNOTCONVERGE: Active region did not converge after '--converge-limit' of 100 tries");
                }
