...
void Vtb_uart_tx___024root__trace_chg_0_sub_0(Vtb_uart_tx___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[2U] 
        ...
        bufp->chgIData(oldp+22,(vlSelfRef.tb_uart_tx__DOT__i),32);
        bufp->chgSData(oldp+23,(vlSelfRef.tb_uart_tx__DOT__sampled_frame),16);
        bufp->chgSData(oldp+24,(vlSelfRef.tb_uart_tx__DOT__expected_frame),16);
    }
