...
VL_ATTR_COLD void Vtb_mux2to1___024root__trace_init_sub__TOP__0(Vtb_mux2to1___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,0,"out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBit(c+7,0,"clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+4,0,"test_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
...
VL_ATTR_COLD void Vtb_mux2to1___024root__trace_full_0_sub_0(Vtb_mux2to1___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(((IData)(vlSelfRef.tb_mux2to1__DOT__sel)
                              ? (IData)(vlSelfRef.tb_mux2to1__DOT__in1)
                              : (IData)(vlSelfRef.tb_mux2to1__DOT__in0))),8);
    bufp->fullIData(oldp+4,(vlSelfRef.tb_mux2to1__DOT__test_count),32);
    bufp->fullIData(oldp+5,(vlSelfRef.tb_mux2to1__DOT__pass_count),32);
    bufp->fullIData(oldp+6,(vlSelfRef.tb_mux2to1__DOT__fail_count),32);
