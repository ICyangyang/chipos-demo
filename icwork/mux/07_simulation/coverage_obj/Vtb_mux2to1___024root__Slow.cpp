...
void Vtb_mux2to1___024root___configure_coverage(Vtb_mux2to1___024root* vlSelf, bool first);

void Vtb_mux2to1___024root::__Vconfigure(bool first) {
    (void)first;  // Prevent unused variable warning
    Vtb_mux2to1___024root___configure_coverage(this, first);
}
...
// Coverage
void Vtb_mux2to1___024root::__vlCoverInsert(uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
...
// Toggle Coverage
void Vtb_mux2to1___024root::__vlCoverToggleInsert(int begin, int end, bool ranged, uint32_t* countp, bool enable, const char* filenamep, int lineno, int column,
