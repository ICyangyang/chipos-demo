...
void Vtb_mux2to1___024root__trace_chg_0_sub_0(Vtb_mux2to1___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+3,(vlSelfRef.tb_mux2to1__DOT__test_count),32);
        bufp->chgIData(oldp+4,(vlSelfRef.tb_mux2to1__DOT__pass_count),32);
        bufp->chgIData(oldp+5,(vlSelfRef.tb_mux2to1__DOT__fail_count),32);
    }
    bufp->chgCData(oldp+6,(vlSelfRef.tb_mux2to1__DOT__out),8);
