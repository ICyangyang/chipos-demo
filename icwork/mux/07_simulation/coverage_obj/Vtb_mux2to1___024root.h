...
class alignas(VL_CACHE_LINE_BYTES) Vtb_mux2to1___024root final {
  public:
    ...
    CData/*7:0*/ tb_mux2to1__DOT____Vtogcov__in0;
    CData/*7:0*/ tb_mux2to1__DOT____Vtogcov__in1;
    CData/*0:0*/ tb_mux2to1__DOT____Vtogcov__sel;
    CData/*7:0*/ tb_mux2to1__DOT____Vtogcov__out;
    CData/*0:0*/ tb_mux2to1__DOT____Vtogcov__clk;
    ...
    VlWide<8>/*255:0*/ tb_mux2to1__DOT____Vtogcov__test_name;
